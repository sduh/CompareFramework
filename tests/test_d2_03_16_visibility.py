...
MODULE_PATH = 'Modes/CF_ModeReference.bas'
PRIVATE_TARGETS = ['CF_BuildReferencePlan', 'CF_ReferenceIsTargetSheet', 'CF_ReferenceSheetHasKey', 'CF_ReferencePlanSetStatus', 'CF_ReferenceFormatPlan', 'CF_ReferenceBuildSummary', 'CF_ReferenceFormatSummary']

class D20316VisibilityTests(unittest.TestCase):
    def test_selected_batch_is_private(self):
    ...
    def test_all_documented_keep_public_symbols_are_public(self):
        root = Path(__file__).resolve().parents[1]

...
'=========================================================
' CompareFramework V2.6 - Execution Context
'=========================================================
' Goal:
...
Public Sub CF_ContextDumpToSheet()
    ...
    MsgBox "Contexte exporté dans Compare_Context.", 64, "CompareFramework V2.6"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_ContextDumpToSheet : " & Err & " - " & Error$, 16, "CompareFramework V2.6"
End Sub
...
'=========================================================
' CompareFramework V2.6 - Reusable Profiles
'=========================================================
' Public API:
...
Public Sub CF_ApplyProfile(sProfileName As String)
    ...
    If rowIndex < 1 Then
        MsgBox "Profil introuvable : " & sProfileName, 48, "CompareFramework V2.6"
        Exit Sub
    End If
    ...
    MsgBox "Profil appliqué : " & UCase(Trim(sProfileName)), 64, "CompareFramework V2.6"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_ApplyProfile : " & Err & " - " & Error$, 16, "CompareFramework V2.6"
End Sub
...
Public Sub CF_SaveCurrentConfigAsProfile(sProfileName As String)
    ...
    If sProfileName = "" Then
        MsgBox "Le nom du profil est obligatoire.", 48, "CompareFramework V2.6"
        Exit Sub
    End If
    ...
    MsgBox "Profil enregistré : " & sProfileName, 64, "CompareFramework V2.6"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_SaveCurrentConfigAsProfile : " & Err & " - " & Error$, 16, "CompareFramework V2.6"
End Sub
...
ErrHandler:
    ...
    MsgBox "Erreur CF_RunWithProfile : " & Err & " - " & Error$, 16, "CompareFramework V2.6"
End Sub

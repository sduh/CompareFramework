...
' CompareFramework V3.6.1 Stable - Monolithic hotfix
' LibreOffice Basic compatible optional parameters

'======================================================================
' CompareFramework_Utils.bas
'======================================================================
' CompareFramework V3.6.1 Stable - Utils
' Constantes globales et utilitaires communs.
Public Const CF_VERSION As String = "3.6.1"
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Execution Context
'=========================================================
' Goal:
...
Public Sub CF_ContextDumpToSheet()
    ...
    MsgBox "Contexte exporté dans Compare_Context.", 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_ContextDumpToSheet : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Execution Audit
'=========================================================
' Public API:
...
ErrHandler:
    MsgBox "Erreur CF_AuditWriteCurrentRun : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_AuditClearHistory()
    ...
    CF_AuditEnsureSheet oDoc
    MsgBox "Historique d'audit réinitialisé.", 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_AuditClearHistory : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
' CompareFramework V3.6.1 Stable - Config
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Reusable Profiles
'=========================================================
' Public API:
...
Public Sub CF_ApplyProfile(sProfileName As String)
    ...
    If rowIndex < 1 Then
        MsgBox "Profil introuvable : " & sProfileName, 48, "CompareFramework V3.6.1 Stable"
        Exit Sub
    End If
    ...
    MsgBox "Profil appliqué : " & UCase(Trim(sProfileName)), 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_ApplyProfile : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_SaveCurrentConfigAsProfile(sProfileName As String)
    ...
    If sProfileName = "" Then
        MsgBox "Le nom du profil est obligatoire.", 48, "CompareFramework V3.6.1 Stable"
        Exit Sub
    End If
    ...
    MsgBox "Profil enregistré : " & sProfileName, 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_SaveCurrentConfigAsProfile : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    ...
    MsgBox "Erreur CF_RunWithProfile : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
' CompareFramework V3.6.1 Stable - Index
...
'======================================================================
' CompareFramework V3.6.1 Stable - Rules
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Comparator configuration
...
Public Sub CF_ReloadComparatorConfig()
    ...
    MsgBox "Configuration des comparateurs rechargee : " & CF_CC_COUNT & " regle(s).", 64, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunComparatorConfigTests()
    ...
    If ok1 And ok2 And ok3 Then
        MsgBox "Tests configuration comparateurs : 3/3", 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Tests configuration comparateurs a controler.", 48, "CompareFramework V3.6.1 Stable"
    End If
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunComparatorConfigTests : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Typed comparators
...
Public Sub CF_RunTypedComparatorTests()
    ...
    If ok1 And ok2 And ok3 And ok4 And ok5 And ok6 Then
        MsgBox "Tests comparateurs types : 6/6", 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Tests comparateurs types a controler.", 48, "CompareFramework V3.6.1 Stable"
    End If
End Sub
...
'======================================================================
' CompareFramework V3.6.1 Stable - Report
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Validation and Preflight
'=========================================================
' Public API:
...
Public Sub CF_RunValidated()
    ...
    If Not CF_PreflightComparison() Then
        ...
        MsgBox "Validation échouée. Consulte la feuille Compare_Validation.", 48, "CompareFramework V3.6.1 Stable"
        Exit Sub
    End If
...
ErrHandler:
    ...
    CF_ContextSet "ErrorMessage", Error$
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur CF_RunValidated : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Performance & Metrics
'=========================================================
' Public API:
'   CF_PerfReset()
'   CF_PerfStart(label)
...
Public Sub CF_PerfWriteReport()
    ...
    Exit Sub
ErrHandler:
    MsgBox "Erreur CF_PerfWriteReport : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunPerformanceBenchmark()
    ...
    Next i
    CF_PerfWriteReport
    MsgBox "Benchmark terminé. Consulte Compare_Performance.", 64, "CompareFramework V3.6.1 Stable"
    Exit Sub
ErrHandler:
    MsgBox "Erreur CF_RunPerformanceBenchmark : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - In-memory comparison engine
...
Public Sub CF_RunMemoryEngineTests()
    ...
    If okRead And okHeaders And okIndex Then
        MsgBox "Tests moteur memoire : 3/3", 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Tests moteur memoire a controler." & Chr(10) & _
               ...
               48, "CompareFramework V3.6.1 Stable"
    End If
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunMemoryEngineTests : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Typed Comparator Reliability
'=========================================================
' Public API:
...
Public Sub CF_RunTypedRegressionSuite()
    ...
    If passed = total Then
        MsgBox "Régression typée OK : " & passed & "/" & total, 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Régression typée à contrôler : " & passed & "/" & total, 48, "CompareFramework V3.6.1 Stable"
    End If
    Exit Sub

ErrHandler:
    gIgnoreCase = previousIgnoreCase
    MsgBox "Erreur CF_RunTypedRegressionSuite : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_ValidateComparatorRules()
    ...
    CF_ReliabilityFormat oSheet
    MsgBox "Validation des comparateurs terminée.", 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_ValidateComparatorRules : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_BuildComparatorCoverageReport()
    ...
    CF_ReliabilityFormat oSheet
    MsgBox "Rapport de couverture généré.", 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_BuildComparatorCoverageReport : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunMilestoneB_FinalTests()
    ...
    MsgBox "Jalon B V3.3 terminé. Consulte les feuilles de test et validation.", 64, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Milestone C Quality Suite
'=========================================================
' Public API:
...
ErrHandler:
    MsgBox "Erreur CF_RunEndToEndScenario : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_ValidateExpectedReport()
    ...
    If Not oDoc.Sheets.hasByName("CF_Expected") Then
        MsgBox "Feuille CF_Expected absente.", 48, "CompareFramework V3.6.1 Stable"
        Exit Sub
    End If

    If Not oDoc.Sheets.hasByName("Rapport_Comparaison") Then
        MsgBox "Feuille Rapport_Comparaison absente.", 48, "CompareFramework V3.6.1 Stable"
        Exit Sub
    End If
    ...
    If passed = total Then
        MsgBox "Scénario de bout en bout validé : " & passed & "/" & total, 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Scénario à contrôler : " & passed & "/" & total, 48, "CompareFramework V3.6.1 Stable"
    End If
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_ValidateExpectedReport : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    MsgBox "Erreur CF_PrepareRegressionEnvironment : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunGlobalRegression()
    ...
    MsgBox "Régression globale terminée. Consulte CF_Quality_Dashboard.", 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunGlobalRegression : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    MsgBox "Erreur CF_BuildQualityDashboard : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Milestone C Stabilisation
'=========================================================
' Business scenarios:
'   FINANCE
'   RH
...
Public Sub CF_RunAllBusinessScenarios()
    ...
    MsgBox "Scénarios métier terminés. Consulte CF_Scenario_Results et CF_Release_Readiness.", 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunAllBusinessScenarios : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_BuildReleaseReadiness()
    ...
    CF_ScenarioReadinessRow oSheet, 6, "Décision", releaseStatus, "CompareFramework V3.6.1 Stable"

    CF_ScenarioFormat oSheet
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_BuildReleaseReadiness : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
'=========================================================
' CompareFramework V3.6.1 Stable - Test Suite
'=========================================================
' Public macros:
'   CF_RunAllTests()
'   CF_CreateTestWorkbook()
...
Public Sub CF_CreateTestWorkbook()
    ...
    MsgBox "Jeu de test créé : " & CF_TEST_SHEET_OLD & " / " & CF_TEST_SHEET_NEW, 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_CreateTestWorkbook : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunAllTests()
    ...
    If passed = total Then
        MsgBox "Tests OK : " & passed & "/" & total, 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Tests à contrôler : " & passed & "/" & total, 48, "CompareFramework V3.6.1 Stable"
    End If

    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunAllTests : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunContextTests()
    ...
    MsgBox "Tests contexte : " & passed & "/" & total, 64, "CompareFramework V3.6.1 Stable"
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunContextTests : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunProfileTests()
    ...
    If okSheet And okStandard And okFinance Then
        MsgBox "Tests profils : 3/3", 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Tests profils incomplets.", 48, "CompareFramework V3.6.1 Stable"
    End If
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunProfileTests : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunValidationTests()
    ...
    If ThisComponent.Sheets.hasByName("Compare_Validation") Then
        MsgBox "Validation exécutée. Résultat global : " & IIf(ok, "OK", "KO"), 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Echec : feuille Compare_Validation absente.", 16, "CompareFramework V3.6.1 Stable"
    End If
End Sub
...
Public Sub CF_RunAuditTests()
    ...
    If bRunId And bMetric And bSheet Then
        MsgBox "Tests audit : 3/3", 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Tests audit à contrôler.", 48, "CompareFramework V3.6.1 Stable"
    End If

    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunAuditTests : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunPerformanceTests()
    ...
    If okTimer And okReport Then
        MsgBox "Tests performance : 2/2", 64, "CompareFramework V3.6.1 Stable"
    Else
        MsgBox "Tests performance à contrôler.", 48, "CompareFramework V3.6.1 Stable"
    End If
    Exit Sub

ErrHandler:
    MsgBox "Erreur CF_RunPerformanceTests : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'======================================================================
' CompareFramework V3.6.1 Stable - Main
...
ErrHandler:
    ...
    CF_AuditEnd "ERROR"
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur Jalon A : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub DiagnosticFramework()
    MsgBox "CompareFramework V3.6.1 Stable" & Chr(10) & _
...
ErrHandler:
    ...
    CF_ContextSet "ErrorMessage", Error$
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur comparaison contextualisée : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    ...
    MsgBox "Erreur CF_RunAudited : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
Public Sub CF_RunPerformanceProfiled()
    ...
    If Not CF_ValidateFramework(False) Then
        ...
        CF_AuditEnd "VALIDATION_FAILED"
        CF_ContextEndRun "VALIDATION_FAILED"
        MsgBox "Validation échouée. Consulte Compare_Validation.", 48, "CompareFramework V3.6.1 Stable"
        Exit Sub
    End If
    CF_PerfStop "Validation"
...
ErrHandler:
    ...
    CF_AuditEnd "ERROR"
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur CF_RunPerformanceProfiled : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    ...
    CF_AuditEnd "ERROR"
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur Jalon B : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    ...
    CF_AuditEnd "ERROR"
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur CF_RunMilestoneB_Configured : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    ...
    CF_AuditEnd "ERROR"
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur CF_RunMilestoneB_Final : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    ...
    CF_AuditEnd "ERROR"
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur CF_RunMilestoneC : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
ErrHandler:
    ...
    CF_AuditEnd "ERROR"
    CF_ContextEndRun "ERROR"
    MsgBox "Erreur CF_RunMilestoneC_Final : " & Err & " - " & Error$, 16, "CompareFramework V3.6.1 Stable"
End Sub
...
'=========================================================
' CompareFramework V3.6.1 Stable - Final validation entry point
'=========================================================
...
Public Sub CF_RunStableValidation()
    ...
    CF_AuditSet "Release", "3.6 Stable"
    CF_AuditSet "Validation", "COMPLETE"
    CF_AuditEnd "DONE"
    CF_ContextEndRun "DONE"

    MsgBox "Validation V3.6 Stable terminée." & Chr(10) & _
           "Consulte CF_Release_Readiness et Compare_Audit.", _
           64, "CompareFramework V3.6.1 Stable"
    Exit Sub
...
ErrHandler:
    ...
    MsgBox "Erreur CF_RunStableValidation : " & Err & " - " & Error$, _
           16, "CompareFramework V3.6.1 Stable"
End Sub
